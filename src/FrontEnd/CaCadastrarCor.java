 ...
 * @author Igor
 */
public class CaCadastrarCor extends javax.swing.JDialog {
    
    private ConexaoMySQL c;
    private int Cod;

    /**
     * Creates new form CaCadastrarCor
     */
    public CaCadastrarCor(int Codigo) {
        initComponents();
        this.c = new ConexaoMySQL();
        this.setModal(true);
        Cod= Codigo;
        this.setTitle("Cadastrando Cor");
        
        
        if(Codigo == 0){
            this.setTitle("Cadastrando Cores");

        }
        else{
            this.setTitle("Editando Cores");

            try{
                String SQL="select * From cor where codCor = "+Codigo;
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
            ...
            if(TamanhoNome>=1){
                    ...
                    if(Cod==0){
                        String SQL="Insert into cor(Nome)"
                        ...
                        String SQL= "Update cor set Nome = '"+txtNome.getText()+"' where( CodCor = '"+Cod+"' )";
                        //System.out.print(SQL);
                        this.c.SQLExecute(SQL);
                        this.dispose();
